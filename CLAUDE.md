...
- `docs/phase4-baseline.md` — Phase 4 end state: version back-test V3.9.10/11/12 on arm-bookworm-sqlite. Residual identical across all three tags (−16,384 B SBFspot, −4,096 B daemon). Gate passed; version axis orthogonal to DB/codename/arch.
